...
public class TestEndsWithUpperCaseLetter {
	...
	public void testEndsWithUpperCaseLetterN01() {
		numberOfTests++;
		Assert.assertTrue(TwelveProblems.endsWithUpperCaseLetter("doG"));
		testsPassed++;
	...
	public void testEndsWithUpperCaseLetterN02() {
		numberOfTests++;
		Assert.assertFalse(TwelveProblems.endsWithUpperCaseLetter("dog"));
		testsPassed++;
	...
	public void testEndsWithUpperCaseLetterN03() {
		numberOfTests++;
		Assert.assertTrue(TwelveProblems.endsWithUpperCaseLetter("HELLO"));
		testsPassed++;
	...
	public void testEndsWithUpperCaseLetterN04() {
		numberOfTests++;
		Assert.assertFalse(TwelveProblems.endsWithUpperCaseLetter("hello"));
		testsPassed++;
	...
	public void testEndsWithUpperCaseLetterN05() {
		numberOfTests++;
		Assert.assertFalse(TwelveProblems.endsWithUpperCaseLetter(""));
		testsPassed++;
