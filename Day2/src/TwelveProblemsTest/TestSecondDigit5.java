...
public class TestSecondDigit5 {
	...
	public void testSecondDigit5N01() {
		numberOfTests++;
		Assert.assertTrue(TwelveProblems.secondDigit5(50));
		testsPassed++;
	} // testSecondDigit5N0
	...
	public void testSecondDigit5N02() {
		numberOfTests++;
		Assert.assertTrue(TwelveProblems.secondDigit5(55));
		testsPassed++;
	} // testSecondDigit5N02
	...
	public void testSecondDigit5N03() {
		numberOfTests++;
		Assert.assertTrue(TwelveProblems.secondDigit5(450));
		testsPassed++;
	} // testSecondDigit5N03
	...
	public void testSecondDigit5N04() {
		numberOfTests++;
		Assert.assertTrue(TwelveProblems.secondDigit5(11251));
		testsPassed++;
	} // testSecondDigit5N04
	...
	public void testSecondDigit5N05() {
		numberOfTests++;
		Assert.assertTrue(TwelveProblems.secondDigit5(555555));
		testsPassed++;
	} // testSecondDigit5N05
	...
	public void testSecondDigit5N06() {
		numberOfTests++;
		Assert.assertFalse(TwelveProblems.secondDigit5(555505));
		testsPassed++;
	} // testSecondDigit5N06
	...
	public void testSecondDigit5N07() {
		numberOfTests++;
		Assert.assertFalse(TwelveProblems.secondDigit5(5));
		testsPassed++;
	} // testSecondDigit5N07
	...
	public void testSecondDigit5N08() {
		numberOfTests++;
		Assert.assertFalse(TwelveProblems.secondDigit5(230));
		testsPassed++;
	} // testSecondDigit5N08
}
